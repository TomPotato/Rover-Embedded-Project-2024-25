...
<ol>
    ...
    <li>Upload "RoverArduinoFinalSketch.ino" on Arduino Uno using <a href="https://www.arduino.cc/en/software">Arduino IDE</a></li> 
    <i>(check that the baudrate of the Arduino board and BT Module are compatible)</i>
